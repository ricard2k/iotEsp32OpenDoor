...
const char HTML_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/WiFi\" method=\"get\"><button>Configure WiFi</button></form><br/><form action=\"/0WiFi\" method=\"get\"><button>Configure WiFi (No Scan)</button></form><br/>";
...
const char HTML_FORM_START[] PROGMEM      = "<form method='get' action='WiFisave'><input id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='password' placeholder='password'><br/>";
const char HTML_FORM_PARAM[] PROGMEM      = "<br/><input id='{i}' name='{n}' length={l} placeholder='{p}' value='{v}' {c}>";
...
const char HTML_SAVED[] PROGMEM           = "<div>Credentials Saved<br />Trying to connect Weread to network.<br />If it fails reconnect to AP to try again</div>";
